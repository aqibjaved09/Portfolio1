  ...
  const projects = [
    {
      ...
      demo: "#",
      code: "https://github.com Management-System",
    },
    {
    ...
    },
    {
      ...
      demo: "https://quiz-app.vercel.app/QuizApp.html",
      code: "https://github.com App",
    },
  ];
    ...
    <section id="projects" className="min-vh-100 text-light pt-5" style={{ backgroundColor: "#0d0d0d" }}>
      <div className="container py-5">
        ...
        <div className="text-center mt-5">
          <a href="https://github.com/aqibjaved09" target="_blank" rel="noopener noreferrer" className="btn btn-view-all btn-lg px-5 py-3 fw-semibold">
            View All Projects
          </a>
        </div>
      </div>
