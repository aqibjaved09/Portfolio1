          ...
          <div className="row text-center text-md-start">
            ...
            <div className="col-md-4 mb-4">
              ...
              <p className=" mb-4" style={{ lineHeight: "1.7" }}>
                Python Developer Digital Solutions passionate about creating amazing web experiences 
  ...
  <div className="freelance-dot" />
            ...
            <div className="col-md-4 mb-4">
              ...
              <div className="d-flex justify-content-center justify-content-md-start gap-3 mb-4">
                ...
                <a
                  href="mailto:maqibjaveed4@gmail.com"
                  className="social-icon-footer d-flex align-items-center justify-content-center"
                >
                  <FaEnvelope />
                </a>
              ...
              <p className=" small">
                <strong>Email:</strong> maqibjaveed4@gmail.com<br />
          ...
          <div className="footer-bottom text-center">
            <p className="mb-0">
              © 2025 Muhammad Aqib Javeed. Made with{" "}
               and lots of{" "}
               </p>
            <small className="">
              Designed & Developed with modern Digital technologies
            </small>
          </div>
        </div>
