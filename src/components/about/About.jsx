...
const About = () => {
  ...
  const stats = [
    { number: "10+", label: "Business Ideas", icon: <FaCode />, delay: "0.2s" },
    { number: "25+", label: "Happy Clients", icon: <FaLaptopCode />, delay: "0.4s" },
            ...
            >
              <FloatingElement delay="0.5s">
                <p className="lead mb-4 about-lead">
                  I build digital solutions that make business easier. As a Computer Engineering graduate,
                  I combine technical expertise with business understanding to create {" "}
                  <span className="about-highlight">Python applications, APIs, and automated systems </span> that solve real problems.
                  Whether you need to {" "}
                  <span className="about-highlight">automate workflows</span>{" "}
                  , process data efficiently, or build scalable web applications,
                   I deliver solutions that are reliable, maintainable, and aligned with your business goals
              ...
              <FloatingElement delay="1s">
                <p className="mb-4 about-paragraph">
                  My passion is creating technology that not only functions
                   flawlessly but also adds tangible value to your operations 
                   and bottom line.
                </p>
              </FloatingElement>
            </div>
